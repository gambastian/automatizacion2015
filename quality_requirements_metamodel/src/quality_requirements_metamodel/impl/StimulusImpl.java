 ...
 * <ul>
 *   <li>{@link quality_requirements_metamodel.impl.StimulusImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StimulusImpl extends MinimalEObjectImpl.Container implements Stimulus {
	...
	protected EClass eStaticClass() {
		return Quality_requirements_metamodelPackage.Literals.STIMULUS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Quality_requirements_metamodelPackage.STIMULUS__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Quality_requirements_metamodelPackage.STIMULUS__NAME:
				return getName();
		}

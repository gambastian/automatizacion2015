 ...
 * @generated
 */
public class Quality_requirements_metamodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Quality_requirements_metamodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Quality_requirements_metamodelPackage.QUALITY_SCENARIO: {
				QualityScenario qualityScenario = (QualityScenario)theEObject;
				T result = caseQualityScenario(qualityScenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Quality_requirements_metamodelPackage.ARCHITECTURE: {
				Architecture architecture = (Architecture)theEObject;
				T result = caseArchitecture(architecture);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Quality_requirements_metamodelPackage.DASHBOARD: {
				Dashboard dashboard = (Dashboard)theEObject;
				T result = caseDashboard(dashboard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Quality_requirements_metamodelPackage.STIMULUS: {
				Stimulus stimulus = (Stimulus)theEObject;
				T result = caseStimulus(stimulus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Quality_requirements_metamodelPackage.RESPONSE_METRIC: {
				ResponseMetric responseMetric = (ResponseMetric)theEObject;
				T result = caseResponseMetric(responseMetric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Response Metric</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Response Metric</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResponseMetric(ResponseMetric object) {
		return null;
	}
...
} //Quality_requirements_metamodelSwitch
